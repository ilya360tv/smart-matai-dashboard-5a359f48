import { Package, Users, Building2, Menu, Home, History, DollarSign, Receipt, ShoppingCart, Database, FileText } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ShoppingCart, label: "הזמנות ממשווקים", href: "/orders" },
